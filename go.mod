...
require (
	...
	github.com/hashicorp/terraform-provider-kubernetes v1.13.4-0.20210415165517-b5770d4b51a1
...
require (
	...
	k8s.io/cli-runtime v0.19.1 // indirect
	k8s.io/component-base v0.19.1 // indirect
